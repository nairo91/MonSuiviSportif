      ...
      <div className="glass-card w-full max-w-[430px] overflow-hidden p-6">
        ...
        <div className="mb-6 rounded-[24px] border border-white/8 bg-white/4 p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Quelques infos suffisent. L&apos;app charge votre bibliotheque de base, sans aucune
            seance fictive, puis sauvegarde ensuite vos vraies donnees.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="focus" value={focus} onChange={(event) => setFocus(event.target.value)} />
          </div>
          <div className="space-y-2">
  ...
  return (
    <>
      ...
      {!preferences.onboardingCompleted ? (
        <OnboardingForm
          key={`${profile.name}-${profile.trainingFocus}-${profile.weeklyTarget}`}
          profile={profile}
